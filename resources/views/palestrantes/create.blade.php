...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['id' => 'frm_palestrante_novo', 'url' => ['palestrante']]) !!}
                <div class="row">
                    <div class="col-md-3">
                            ...
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <div class="profile-img p-3">
                                        <img src="{{ url('img/icon-cam.png') }}" id="profile-pic">
                                    </div>
                    ...
                    <div class="col-md-9">
                        <input type="hidden" name="path_imagem_pal" id="path_imagem_pal">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ds_email_pes" placeholder="Email">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group pr-2">
                                    <label>Nome Completo <span class="text-danger">Obrigatório</span></label>
                                    <input type="text" class="form-control" name="nm_pessoa_pes" placeholder="Nome Completo">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Empresa</label>
                                    <input type="text" class="form-control" name="ds_empresa_pal" placeholder="Empresa">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group pr-2">
                                    <label>Cargo</label>
                                    <input type="text" class="form-control" name="ds_cargo_pal" placeholder="Cargo">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 pr-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ds_tratamento_pal" placeholder="Sr, Dr, Prof., por exemplo">
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group pr-2">
                                    ...
                                    <textarea class="form-control" name="biografia_pal" row="8"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
